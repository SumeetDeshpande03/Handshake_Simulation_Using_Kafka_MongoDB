...
class CompanyProfile extends React.Component{
  ...
  componentDidMount() {
    ...
    axios.get(`http://localhost:3000/company/companyProfile/${id}`).then(res => {
      if (res.status === 200) {
        ...
        console.log(res);
        this.setState({ error: 'Company Not found' });
        ...
        <div>
          {/* {this.state.redirect} */}
            ...
            <div style={{float:'left', width:'40%'}}>
              ...
              <p>Company Description: {this.state.location}</p>
              <p>Company Location: {this.state.description}</p>
